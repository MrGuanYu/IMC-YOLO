...
__all__ = ['iRMB_EMAcbam', 'C2f_iRMB_EMAcbam']

from ultralytics.nn.addModule import emaCBAM
...
class C2f_iRMB_EMAcbam(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(emacbamBottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
