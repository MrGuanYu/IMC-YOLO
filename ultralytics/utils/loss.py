...
class BboxLoss(nn.Module):
    ...
    def forward(self, pred_dist, pred_bboxes, anchor_points, target_bboxes, target_scores, target_scores_sum, fg_mask,hw):
        ...
        iou = bbox_iou(pred_bboxes[fg_mask], target_bboxes[fg_mask],
                           xywh=False, GIoU=False, DIoU=False, CIoU=True, EIoU=True, SIoU=False,
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "i.e. 'yolo train model=IMC-YOLO-seg.pt data=coco8.yaml'.\nVerify your dataset is a "
    ...
    def __call__(self, preds, batch):
        ...
        try:
            ...
            raise TypeError(
                ...
                "i.e. 'yolo train model=IMC-YOLO-obb.pt data=dota8.yaml'.\nVerify your dataset is a "
