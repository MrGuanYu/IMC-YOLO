...
model = YOLO("IMC-YOLO.pt")  # Load an official Detect model
model = YOLO("IMC-YOLO-seg.pt")  # Load an official Segment model
model = YOLO("IMC-YOLO-pose.pt")  # Load an official Pose model
...
yolo track model=IMC-YOLO.pt source="https://youtu.be/LNwODJXcvt4"  # Official Detect model
yolo track model=IMC-YOLO-seg.pt source="https://youtu.be/LNwODJXcvt4"  # Official Segment model
yolo track model=IMC-YOLO-pose.pt source="https://youtu.be/LNwODJXcvt4"  # Official Pose model
...
yolo track model=IMC-YOLO.pt source="https://youtu.be/LNwODJXcvt4" conf=0.3, iou=0.5 show
```
...
yolo track model=IMC-YOLO.pt source="https://youtu.be/LNwODJXcvt4" tracker='custom_tracker.yaml'
```
...
# Load the models
model1 = YOLO("IMC-YOLO.pt")
model2 = YOLO("IMC-YOLO-seg.pt")
