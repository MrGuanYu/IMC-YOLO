...
class datBottleneck(nn.Module):
    ...
    def forward(self, x):
        ...
        return x + self.dat(self.cv2(self.cv1(x))) if self.add else self.cv2(self.cv1(x))


class datC2f(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        ...
        self.m = nn.ModuleList(datBottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
