...
parser.add_argument('--root_dir', default=r'D:\program6\python\ultralytics\myDatasets\Datasets\hole\train', type=str,
                    help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str, default=r'D:\program6\python\ultralytics\myRubbish\goupi.json',
...
def yolo2coco(root_path):
    ...
    # for i, cls in enumerate(classes, 0):
    dataset['categories'].append({'id': 0, 'name': 'val', 'supercategory': 'mark'})
